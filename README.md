...
# > Dler Cloud墙洞 签到
dlercloud.js = cronexp=0 8-20/4 * * *,script-path=https://raw.githubusercontent.com/Darren-X1/S/master/dlercloud.js,type=cron,script-update-interval=0
# > 天气预报 一周
weather_pro.js = cronexp=0 8-20/4 * * *,script-path=mutu/weather_pro.js,cronexp=0 8-20/4 * * *,type=cron,script-update-interval=0
# 电信流量话费提醒
china_telecom.js = cronexp=0 9 * * *,type=cron,script-path=https://raw.githubusercontent.com/nzw9314/QuantumultX/master/Task/china_telecom.js,script-update-interval=0
